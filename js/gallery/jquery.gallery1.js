/*
Req : array<a> must be passed
a must have img(thumbnail) in it

<a href="{full}"><img(thumb)/></a>
$('a').fadeGallery({options});
...
$.fn.fadeGallery=function(){
	...
	args.thumbWidth=parseInt(args.thumbWidth)||false;
	args.thumbHeight=parseInt(args.thumbHeight)||false;
	...
	var thumbWidth = args.thumbWidth!=false? args.thumbWidth : args.thumbSize;
	var thumbHeight = args.thumbHeight!=false? args.thumbHeight : args.thumbSize;
	...
	var thumbSelectFrame=$('<div class="selected"/>').css({
		...
		'width':args.thumbWidth-8+'px',
		'height':args.thumbHeight-8+'px',
	...
	var numThumbs = Math.floor(thumbs.parent().width()/(args.thumbWidth+2));
